...
export default function SumiQuickControls() {
  return (
    <div class="space-y-4">
      <h3 class="font-bold text-xs text-text-main uppercase tracking-widest flex items-center gap-2">
        <Icon name="sliders" class="w-4 h-4 text-brand-500" /> Brush Adjustments
      </h3>

      <div class="space-y-3.5">
        <div>
          <label class="block text-[10px] font-extrabold text-text-muted uppercase tracking-wider mb-1.5">Sumi Text Overlay</label>
          <input 
            type="text" 
            value={canvasText()}
        ...
        <div class="grid grid-cols-2 gap-3.5">
          <div>
            <label class="block text-[10px] font-extrabold text-text-muted uppercase tracking-wider mb-1.5">Ink Brush Color</label>
          ...
          <div>
            <label class="block text-[10px] font-extrabold text-text-muted uppercase tracking-wider mb-1.5">Parchment Background</label>
            <div class="flex items-center gap-2.5 bg-black/5 dark:bg-white/5 border border-border-color px-2.5 py-1.5 rounded-xl">
              <input 
                type="color" 
                value={canvasBgColor()}
